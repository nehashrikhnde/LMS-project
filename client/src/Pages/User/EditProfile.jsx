...
function EditProfile() {
  ...
  function handleImageUpload(e) {
    ...
    if (uploadImage) {
      ...
      fileReader.raedAsDataURL(uploadImage);
...
<h1 className="text-center text-2xl font-semibold">Edit Profile</h1>
            <label className="cursor-pointer" html="image_uploads">
...
<BsPersonCircle className="w-28 h-28 rounded-full m-auto" />
            ...
            <label html="fullName" className="text-lg font-semibold">Full Name</label>
            <input
            required
            type="text"
            name="fullName"
